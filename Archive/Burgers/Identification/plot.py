...
with torch.no_grad():
    ...
    pinn.net.load_state_dict(torch.load("weight_clean.pt", weights_only=False))
...
pinn.net.load_state_dict(torch.load("weight_noisy1.pt", weights_only=False))
...
fig.savefig(
    "solution.png", bbox_inches="tight", pad_inches=0, dpi=500,
)
